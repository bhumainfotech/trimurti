...
const Todo = (props) => {
  const todoList = useSelector((content) =>
    content.Todoapp.allTodoItems.filter((item) => item.isStatus !== "deleted")
  );
                                  ...
                                  <div className="task-container">
                                    ...
                                    <span className="task-action-btn">
                                      ...
                                      <span
                                        ...
                                        title="Mark Complete"
                                        onClick={() =>
                                          handleMarkedTodo(todo.id, status)
                                        }
                                      >
                                        <i className="icon">
                                          <i className="icon-check"></i>
